...
let numberH = document.getElementById('number_H');
let rangeH = document.getElementById('range_H');
let numberS = document.getElementById('number_S');
let rangeS = document.getElementById('range_S');
let numberV = document.getElementById('number_V');
let rangeV = document.getElementById('range_V');
...
colorPicker.on('color:change', function(color) {
  ...
  numberH.value = Math.round(HH);
  numberS.value = Math.round(SS);
  numberV.value = Math.round(VV);
  rangeH.value = Math.round(HH);
  rangeS.value = Math.round(SS);
  rangeV.value = Math.round(VV);
...
function HSVtoRGB(HH, SS, VV){
    ...
    if ( SS == 0 ){
        ...
        let var_h = HH * 6;
        if ( var_h == 6 ) var_h = 0;
        let var_i = Math.round( var_h );
        let var_1 = VV * ( 1 - SS );
        let var_2 = VV * ( 1 - SS * ( var_h - var_i ) );
        let var_3 = VV * ( 1 - SS * ( 1 - ( var_h - var_i ) ) );

        let var_r = 0, var_g = 0, var_b = 0;
        if      ( var_i == 0 ) { var_r = VV     ; var_g = var_3 ; var_b = var_1 }
        else if ( var_i == 1 ) { var_r = var_2 ; var_g = VV     ; var_b = var_1 }
        else if ( var_i == 2 ) { var_r = var_1 ; var_g = VV     ; var_b = var_3 }
        else if ( var_i == 3 ) { var_r = var_1 ; var_g = var_2 ; var_b = VV     }
        else if ( var_i == 4 ) { var_r = var_3 ; var_g = var_1 ; var_b = VV     }
        else                   { var_r = VV     ; var_g = var_1 ; var_b = var_2 }
...
function RGBtoLAB(R, G, B){
    ...
    if ( var_X > 0.008856 ) var_X = Math.pow(var_X, 0.33);
    else                    var_X = ( 7.787 * var_X ) + ( 16 / 116 );
    if ( var_Y > 0.008856 ) var_Y = Math.pow(var_Y, 0.33);
    else                    var_Y = ( 7.787 * var_Y ) + ( 16 / 116 );
    if ( var_Z > 0.008856 ) var_Z = Math.pow(var_Z, 0.33);
